...
using ModLibsTiles.Classes.TileStructure;
using ModLibsTiles.Classes.Tiles.TilePattern;


namespace ModLibsTiles.Commands {
	/// @private
	public class SaveTilesCommand : ModCommand {
		...
		/// @private
		public override string Command => "ml-tiles-save";
		/// @private
		public override string Usage => "/" + this.Command + " 1024 348 32 16 true true";
		/// @private
		public override string Description => "Saves a sample of terrain to file (see ModLoader\\Mod Specific Data\\ModLibsTiles)."
		...
		private bool RunCommand(
			...
			ModCustomDataFileLibraries.PrepareDir( ModLibsTilesMod.Instance );
